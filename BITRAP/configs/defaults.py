...
# ------ MODEL ---
_C.MODEL = CN()
_C.MODEL.INPUT_LEN = 5 # for 30 fps, 15 is 0.5 second # NOTE- changed from 15 to 5.
...
# ------ GOAL -----
_C.MODEL.PRED_GLOBAL=False # Added this line
...
_C.DATASET.MAX_BBOX = [1920, 1440, 1920, 1440] # the max of cxcywh or x1x2y1y2
