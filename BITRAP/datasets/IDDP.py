...
class IDDPDataset(data.Dataset):
    def __init__(self, cfg, split):
        ...
        imdb = IDDPedestrian(data_path=self.root)
        ...
        beh_seq = imdb.generate_data_trajectory_sequence(split, **traj_data_opts) # generates raw sequences
