...
def run(config_file=None):
    ...
    # Calculate min track size based on the time to event.
    ...
    for dataset_idx, dataset in enumerate(model_configs['exp_opts']['datasets']):
        ...
        configs['model_opts']['overlap'] = 0.6 if 'pie' in dataset or 'iddp' in dataset else 0.8 # 0.8 for JAAD
        ...
        elif configs['model_opts']['dataset'] == 'iddp':
            imdb = IDDPedestrian(data_path=path_iddp)
        ...
        # Get the model and distribute it across GPUs.
