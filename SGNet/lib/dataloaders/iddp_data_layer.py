...
from .IDDP_origin import IDDPedestrian

class IDDPDataLayer(data.Dataset):
    def __init__(self, args, split):
        ...
        traj_model_opts['enc_input_type'].extend(['obd_speed'])
        traj_model_opts['prediction_type'].extend(['obd_speed'])
        beh_seq = imdb.generate_data_trajectory_sequence('test', **traj_data_opts) # Gets you the raw data.
    ...
    def convert_normalize_bboxes(self, all_bboxes, all_resolutions, normalize, bbox_type):
        ...
        for i in range(len(all_bboxes)):
            ...
            if normalize == 'zero-one':
                ...
                # print(self.args.min_bbox) # [0,0,0,0]
                # print(self.args.max_bbox) # [1920,1440,1920,1440]
