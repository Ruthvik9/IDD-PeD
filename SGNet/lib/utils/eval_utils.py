...
def eval_jaad_pie_cvae(input_traj, target_traj, cvae_all_dec_traj):
    ...
    tiled_target_traj = bbox_denormalize(tiled_target_traj, W=1920, H=1440)
    cvae_all_dec_traj = bbox_denormalize(cvae_all_dec_traj, W=1920, H=1440)
    ...
    # print("shape of input traj",input_traj.shape)
    # print("Shape of tiled_target_traj",tiled_target_traj.shape)
    # print("shape of cvae_all_dec_traj",cvae_all_dec_traj.shape)
    ...
    MSE_15_temp = np.square(cvae_all_dec_traj_xyxy - tiled_target_traj_xyxy).mean(axis=(1, 3))
    # Calculate indices for the best predictions (smallest MSE)
    best_indices_MSE_15 = MSE_15_temp.argmin(axis=-1)
    # Calculate indices for the worst predictions (largest MSE)
    worst_indices_MSE_15 = MSE_15_temp.argmax(axis=-1)
    ...
    return MSE_15, MSE_05, MSE_10, FMSE, CMSE, CFMSE, FIOU,best_indices_MSE_15,worst_indices_MSE_15
